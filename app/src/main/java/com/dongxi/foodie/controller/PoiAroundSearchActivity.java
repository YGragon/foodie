...
import com.dongxi.foodie.utils.ToastUtil;

import java.util.ArrayList;
import java.util.List;

public class PoiAroundSearchActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        latitude = LocationCode.map.get("latitude");
        longitude = LocationCode.map.get("longitude");
